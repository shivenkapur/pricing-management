export default [
    {
        ...
        CGRank: 'RN',
        ClientData: getRandomClient(getRandomInt(3000)),
        Validation: [
            {
              'General Charges': 2800,
